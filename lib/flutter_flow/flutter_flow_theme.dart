...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color main = const Color(0xFF222831);
  late Color sccand = const Color(0xFF393E46);
  late Color hover = const Color(0xFF00ADB5);
  late Color text = const Color(0xFFEEEEEE);
